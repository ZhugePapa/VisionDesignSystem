...
test('deployment prepares a writable persistent AI runtime without replacing existing secrets', () => {
  ...
  assert.match(environment, /^AI_STANDALONE_CHAT_DEFAULT_MODEL=deepseek-v4-pro$/m)
  assert.match(environment, /^AI_EMBEDDED_ASSISTANT_DEFAULT_MODEL=deepseek-v4-flash$/m)
